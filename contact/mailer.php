...
$email = "help@digitalcrisis.com";

//array of fields in form. (In the format "field_name" => "field_label")
$form_fields = array(
"element0" => 'Your Name:',
"element1" => 'Your Email:',
"element2" => 'Home or Business Phone Number: (Required for a service call)',
"element3" => 'Cell Phone Number:',
"element4" => 'Tentative Time for On-site Appointment:',
"element5" => '',
"element6" => 'Category:',
"element7" => 'Subject:',
"element8" => 'Previous Technician:',
"element9" => 'Message:'
);

$required_fields = array("element0", "element1", "element6", "element7", "element9");
